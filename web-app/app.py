        ...
        try:
            ...
            primary_array = np.array(
                [location, mintemp, maxtemp, rainfall, evaporation, sunshine, windgustdir, windgustspeed, winddir9am,
                 ...
                 cloud3pm, temp9am, temp3pm, raintoday], dtype=object)
            ...
            secondary_array = np.array(
                [Location_NUM, mintemp, maxtemp, rainfall, evaporation, sunshine, WindGustDir_NUM, windgustspeed,
                 WindDir9am_NUM, WindDir3pm_NUM, windspeed9am, windspeed3pm, humidity9am, humidity3pm, pressure9am,
                 pressure3pm, cloud9am, cloud3pm, temp9am, temp3pm, RainToday_NUM], dtype=object)
            ...
            if prediction_CATE == "No":
                flash("Нет, завтра не будет дождя")
            else:
                flash("Да, завтра будет дождь")
